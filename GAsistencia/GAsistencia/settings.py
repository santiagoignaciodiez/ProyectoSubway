"""
Django settings for GAsistencia project.
...
SECRET_KEY = 'django-insecure-bk$c-^izzw-b0@v$m9e@x$#f8y4#y(m4xv9f(1l-r@+*u%bqcr'
...
WSGI_APPLICATION = 'GAsistencia.wsgi.application'
